...
names <- c(
  rep("variable flow velocity", length(river)),
...
interval_labels <- c(
  "<-0.2", "-0.2 to -0.1", "-0.1 to -0.05", "-0.05 to -0.01",
...
for (column in columns) {
  ...
  summarized_values %>%
    ...
    geom_errorbar(aes(y = cor_mean, ymin = cor_lower, ymax = cor_upper),
      width = 0.4,
...
river <- data.frame(
  M1 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 0 + 1):(behav * 1)],
    diff_for_analyse[[col]][["non-behavioural"]][["variable flow velocity"]][(n_behav * 0 + 1):(n_behav * 1)]
  ),
  M2 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 1 + 1):(behav * 2)],
    diff_for_analyse[[col]][["non-behavioural"]][["variable flow velocity"]][(n_behav * 1 + 1):(n_behav * 2)]
  ),
  M3 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 2 + 1):(behav * 3)],
    diff_for_analyse[[col]][["non-behavioural"]][["variable flow velocity"]][(n_behav * 2 + 1):(n_behav * 3)]
  ),
  M4 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 3 + 1):(behav * 4)],
    diff_for_analyse[[col]][["non-behavioural"]][["variable flow velocity"]][(n_behav * 3 + 1):(n_behav * 4)]
  ),
  M5 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 4 + 1):(behav * 5)],
    diff_for_analyse[[col]][["non-behavioural"]][["variable flow velocity"]][(n_behav * 4 + 1):(n_behav * 5)]
  ),
  M6 = c(
    diff_for_analyse[[col]][["behavioural"]][["variable flow velocity"]][(behav * 5 + 1):(behav * 6)],
...
res1 <- data.frame(
  M1 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V1)"]][(behav * 0 + 1):(behav * 1)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V1)"]][(n_behav * 0 + 1):(n_behav * 1)]
  ),
  M2 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V1)"]][(behav * 1 + 1):(behav * 2)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V1)"]][(n_behav * 1 + 1):(n_behav * 2)]
  ),
  M3 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V1)"]][(behav * 2 + 1):(behav * 3)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V1)"]][(n_behav * 2 + 1):(n_behav * 3)]
  ),
  M4 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V1)"]][(behav * 3 + 1):(behav * 4)],
...
res2 <- data.frame(
  M1 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V2)"]][(behav * 0 + 1):(behav * 1)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V2)"]][(n_behav * 0 + 1):(n_behav * 1)]
  ),
  M2 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V2)"]][(behav * 1 + 1):(behav * 2)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V2)"]][(n_behav * 1 + 1):(n_behav * 2)]
  ),
  M3 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V2)"]][(behav * 2 + 1):(behav * 3)],
    diff_for_analyse[[col]][["non-behavioural"]][["reservoir algorithm (V2)"]][(n_behav * 2 + 1):(n_behav * 3)]
  ),
  M4 = c(
    diff_for_analyse[[col]][["behavioural"]][["reservoir algorithm (V2)"]][(behav * 3 + 1):(behav * 4)],
...
snow_set <- data.frame(
  M1 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 0 + 1):(behav * 1)],
    diff_for_analyse[[col]][["non-behavioural"]][["snow on wetlands"]][(n_behav * 0 + 1):(n_behav * 1)]
  ),
  M2 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 1 + 1):(behav * 2)],
    diff_for_analyse[[col]][["non-behavioural"]][["snow on wetlands"]][(n_behav * 1 + 1):(n_behav * 2)]
  ),
  M3 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 2 + 1):(behav * 3)],
    diff_for_analyse[[col]][["non-behavioural"]][["snow on wetlands"]][(n_behav * 2 + 1):(n_behav * 3)]
  ),
  M4 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 3 + 1):(behav * 4)],
    diff_for_analyse[[col]][["non-behavioural"]][["snow on wetlands"]][(n_behav * 3 + 1):(n_behav * 4)]
  ),
  M5 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 4 + 1):(behav * 5)],
    diff_for_analyse[[col]][["non-behavioural"]][["snow on wetlands"]][(n_behav * 4 + 1):(n_behav * 5)]
  ),
  M6 = c(
    diff_for_analyse[[col]][["behavioural"]][["snow on wetlands"]][(behav * 5 + 1):(behav * 6)],
...
# less snow impact
boxplot(list(
  "unaffected" = data_unaffected_basins$mean_precipitation_as_snow,
  "affected" = data_affected_basins$mean_precipitation_as_snow
))
# less local wetlands
boxplot(list(
  "unaffected" = data_unaffected_basins$localWetlands,
